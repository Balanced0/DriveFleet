      ...
      <div className="hero-content text-neutral-content">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
          <div>
            ...
            <h1 className="text-7xl font-extrabold mb-8">Find your <span className="text-orange-500">perfect ride</span> instantly.</h1>
            <p className="text-gray-400 text-xl mb-8">From matte-black coupes to silver electric crossovers — rent the car you want, when you want, with a single tap.</p>
            <div className="flex gap-2">
                <Link href="/explore"><button className="btn bg-orange-500 text-lg text-black rounded-xl px-8">Explore Cars <FaArrowRight /></button></Link>
                <Link href="/add"><button className="btn bg-black text-lg rounded-xl px-8 border-gray-600 hover:bg-orange-500 hover:text-black">List Your Car</button></Link>
            </div>
          </div>
